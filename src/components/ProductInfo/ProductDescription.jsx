      ...
      <div className="prod-descrip-stats">
        ...
        <section className='prod-descrip-quantity'>
          ...
          <div className='prod-counter'>
            <div className='prod-counter-btn' onClick={handleMinus}><i className="fa-solid fa-plus"></i></div>
            <div className='prod-counter-total'> {counter} </div>
            <div className='prod-counter-btn' onClick={handlePlus}><i className="fa-solid fa-minus"></i></div>
          </div>
        </section>
      </div>
